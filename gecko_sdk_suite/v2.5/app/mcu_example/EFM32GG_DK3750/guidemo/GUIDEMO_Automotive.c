...
static void _AutomotiveDemo(void) {
  ...
  PARAM       aParam   [NUM_SCALES];        // Parameters for drawing routine
...
void GUIDEMO_Automotive(void) {
  ...
  //
  if ((bmSeggerLogo70x35.XSize + LOGO_DIST < (xSize - _bmScaleR140.XSize) >> 1) || ((bmSeggerLogo70x35.YSize + LOGO_DIST) < _ySpace)) {
    DrawLogo = 1;
  }
