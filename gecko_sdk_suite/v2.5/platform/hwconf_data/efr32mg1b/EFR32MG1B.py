...
import efr32mg1b.modules.PIN.PIN_Snippets as PIN_Snippets
import efr32mg1b.modules.PORTIO.PORTIO_Snippets as PORTIO_Snippets
import efr32mg1b.halconfig.halconfig_dependency as dep

import efr32mg1b.modules.ACMP0.ACMP_behavior as ACMP_behavior
import efr32mg1b.modules.ACMP1.ACMP_behavior as ACMP_behavior
import efr32mg1b.modules.ADC0.ADC_behavior as ADC_behavior
...
import efr32mg1b.modules.FEM.FEM_behavior as FEM_behavior
...
import efr32mg1b.modules.IDAC0.IDAC_behavior as IDAC_behavior
...
import efr32mg1b.modules.MODEM.MODEM_behavior as MODEM_behavior
...
import efr32mg1b.upgrade as upgrade
import efr32mg1b.upgrade.upgradeDispatch as upgradeDispatch
PROFILE = True
