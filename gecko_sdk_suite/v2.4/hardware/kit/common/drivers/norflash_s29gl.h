...
#ifndef NORFLASH_S29GL_H
#define NORFLASH_S29GL_H
...
typedef enum {
  ...
  NORFLASH_UNSUPPORTED_GEOMETRY = -1,            /**< The flash has an unsupported sector scheme. */
