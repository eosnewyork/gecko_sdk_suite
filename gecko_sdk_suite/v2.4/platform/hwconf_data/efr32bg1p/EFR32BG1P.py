...
import efr32bg1p.modules.ACMP0.ACMP_behavior as ACMP_behavior
import efr32bg1p.modules.ACMP1.ACMP_behavior as ACMP_behavior
import efr32bg1p.modules.ADC0.ADC_behavior as ADC_behavior
...
import efr32bg1p.modules.FEM.FEM_behavior as FEM_behavior
...
import efr32bg1p.modules.IDAC0.IDAC_behavior as IDAC_behavior
...
import efr32bg1p.upgrade as upgrade
import efr32bg1p.upgrade.upgradeDispatch as upgradeDispatch
PROFILE = True
