...
import efr32bg12p.modules.PIN.PIN_Snippets as PIN_Snippets
import efr32bg12p.modules.PORTIO.PORTIO_Snippets as PORTIO_Snippets
import efr32bg12p.halconfig.halconfig_dependency as dep

import efr32bg12p.modules.ACMP0.ACMP_behavior as ACMP_behavior
import efr32bg12p.modules.ACMP1.ACMP_behavior as ACMP_behavior
import efr32bg12p.modules.ADC0.ADC_behavior as ADC_behavior
...
import efr32bg12p.modules.CSEN.CSEN_behavior as CSEN_behavior
...
import efr32bg12p.modules.FEM.FEM_behavior as FEM_behavior
...
import efr32bg12p.modules.IDAC0.IDAC_behavior as IDAC_behavior
...
import efr32bg12p.modules.VDAC0.VDAC_behavior as VDAC_behavior
...
import efr32bg12p.upgrade as upgrade
import efr32bg12p.upgrade.upgradeDispatch as upgradeDispatch
PROFILE = True
