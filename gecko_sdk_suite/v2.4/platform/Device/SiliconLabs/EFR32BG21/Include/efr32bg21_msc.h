...
typedef struct {
  ...
  __IOM uint32_t INST_PAGELOCKWORD0;            /**< Main space page 0-31 lock word                     */
  __IOM uint32_t INST_PAGELOCKWORD1;            /**< Main space page 32-63 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD2;            /**< Main space page 64-95 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD3;            /**< Main space page 96-127 lock word                   */
  ...
  __IOM uint32_t INST_PAGELOCKWORD0_SET;        /**< Main space page 0-31 lock word                     */
  __IOM uint32_t INST_PAGELOCKWORD1_SET;        /**< Main space page 32-63 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD2_SET;        /**< Main space page 64-95 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD3_SET;        /**< Main space page 96-127 lock word                   */
  ...
  __IOM uint32_t INST_PAGELOCKWORD0_CLR;        /**< Main space page 0-31 lock word                     */
  __IOM uint32_t INST_PAGELOCKWORD1_CLR;        /**< Main space page 32-63 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD2_CLR;        /**< Main space page 64-95 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD3_CLR;        /**< Main space page 96-127 lock word                   */
  ...
  __IOM uint32_t INST_PAGELOCKWORD0_TGL;        /**< Main space page 0-31 lock word                     */
  __IOM uint32_t INST_PAGELOCKWORD1_TGL;        /**< Main space page 32-63 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD2_TGL;        /**< Main space page 64-95 lock word                    */
  __IOM uint32_t INST_PAGELOCKWORD3_TGL;        /**< Main space page 96-127 lock word                   */
...
/* Bit fields for MSC INST_PAGELOCKWORD0 */
#define _MSC_INST_PAGELOCKWORD0_RESETVALUE         0x00000000UL                                   /**< Default value for MSC_INST_PAGELOCKWORD0    */
#define _MSC_INST_PAGELOCKWORD0_MASK               0xFFFFFFFFUL                                   /**< Mask for MSC_INST_PAGELOCKWORD0             */
#define _MSC_INST_PAGELOCKWORD0_LOCKBIT_SHIFT      0                                              /**< Shift value for MSC_LOCKBIT                 */
#define _MSC_INST_PAGELOCKWORD0_LOCKBIT_MASK       0xFFFFFFFFUL                                   /**< Bit mask for MSC_LOCKBIT                    */
#define _MSC_INST_PAGELOCKWORD0_LOCKBIT_DEFAULT    0x00000000UL                                   /**< Mode DEFAULT for MSC_INST_PAGELOCKWORD0     */
#define MSC_INST_PAGELOCKWORD0_LOCKBIT_DEFAULT     (_MSC_INST_PAGELOCKWORD0_LOCKBIT_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_INST_PAGELOCKWORD0*/

/* Bit fields for MSC INST_PAGELOCKWORD1 */
#define _MSC_INST_PAGELOCKWORD1_RESETVALUE         0x00000000UL                                   /**< Default value for MSC_INST_PAGELOCKWORD1    */
#define _MSC_INST_PAGELOCKWORD1_MASK               0xFFFFFFFFUL                                   /**< Mask for MSC_INST_PAGELOCKWORD1             */
#define _MSC_INST_PAGELOCKWORD1_LOCKBIT_SHIFT      0                                              /**< Shift value for MSC_LOCKBIT                 */
#define _MSC_INST_PAGELOCKWORD1_LOCKBIT_MASK       0xFFFFFFFFUL                                   /**< Bit mask for MSC_LOCKBIT                    */
#define _MSC_INST_PAGELOCKWORD1_LOCKBIT_DEFAULT    0x00000000UL                                   /**< Mode DEFAULT for MSC_INST_PAGELOCKWORD1     */
#define MSC_INST_PAGELOCKWORD1_LOCKBIT_DEFAULT     (_MSC_INST_PAGELOCKWORD1_LOCKBIT_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_INST_PAGELOCKWORD1*/

/* Bit fields for MSC INST_PAGELOCKWORD2 */
#define _MSC_INST_PAGELOCKWORD2_RESETVALUE         0x00000000UL                                   /**< Default value for MSC_INST_PAGELOCKWORD2    */
#define _MSC_INST_PAGELOCKWORD2_MASK               0xFFFFFFFFUL                                   /**< Mask for MSC_INST_PAGELOCKWORD2             */
#define _MSC_INST_PAGELOCKWORD2_LOCKBIT_SHIFT      0                                              /**< Shift value for MSC_LOCKBIT                 */
#define _MSC_INST_PAGELOCKWORD2_LOCKBIT_MASK       0xFFFFFFFFUL                                   /**< Bit mask for MSC_LOCKBIT                    */
#define _MSC_INST_PAGELOCKWORD2_LOCKBIT_DEFAULT    0x00000000UL                                   /**< Mode DEFAULT for MSC_INST_PAGELOCKWORD2     */
#define MSC_INST_PAGELOCKWORD2_LOCKBIT_DEFAULT     (_MSC_INST_PAGELOCKWORD2_LOCKBIT_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_INST_PAGELOCKWORD2*/

/* Bit fields for MSC INST_PAGELOCKWORD3 */
#define _MSC_INST_PAGELOCKWORD3_RESETVALUE         0x00000000UL                                   /**< Default value for MSC_INST_PAGELOCKWORD3    */
#define _MSC_INST_PAGELOCKWORD3_MASK               0xFFFFFFFFUL                                   /**< Mask for MSC_INST_PAGELOCKWORD3             */
#define _MSC_INST_PAGELOCKWORD3_LOCKBIT_SHIFT      0                                              /**< Shift value for MSC_LOCKBIT                 */
#define _MSC_INST_PAGELOCKWORD3_LOCKBIT_MASK       0xFFFFFFFFUL                                   /**< Bit mask for MSC_LOCKBIT                    */
#define _MSC_INST_PAGELOCKWORD3_LOCKBIT_DEFAULT    0x00000000UL                                   /**< Mode DEFAULT for MSC_INST_PAGELOCKWORD3     */
#define MSC_INST_PAGELOCKWORD3_LOCKBIT_DEFAULT     (_MSC_INST_PAGELOCKWORD3_LOCKBIT_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_INST_PAGELOCKWORD3*/
