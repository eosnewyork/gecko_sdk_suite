...
#define FEAT_MCUMAJOR                            "Z"        /** Mcu Major Feature Code */
#define FEAT_MCUMINOR                            0U         /** MCU Minor Feature Code */
#define FEAT_RFMAJOR                             0U         /** Rf Major Feature Code */
...
#define FEAT_SWRELCNTL                           "20180115" /** SW-Tools support rlease date (yyyymmdd) for controlled release */
